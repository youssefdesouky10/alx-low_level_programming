...
class _SearchResultState extends State<SearchResult> {
  ...
  void initState() {
    ...
    Provider.of<AppState>(context, listen: false)
        .fetchSearch(widget.text as String);
  }
      ...
      builder: (context, state, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(widget.text as String),
          ),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(state.search
                                        .search![index].poster as String),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                // color: Colors.white,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.symmetric(
                                                horizontal: 10.0),
                                            child: Text(state.search
                                                .search![index].type as String),
                                          ),
                                          Padding(
                                            padding: EdgeInsets.symmetric(
                                                horizontal: 10.0),
