...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Provider.of<AppState>(context, listen: false)
        .getMovieDetail(widget.imdbId as String);
  }
...
// 6 line
  ...
  Widget build(BuildContext context) {
    ...
    final YoutubePlayerController _controller = YoutubePlayerController(
      initialVideoId: state.youtubeTrailerKey as String, // id youtube video
    ...
    return Consumer<AppState>(builder: (context, state, child) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: Text(state.detail.title as String),
        ),
            ...
            : ListView(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    subtitle: Text(state.detail.description as String,
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                        state.detail.tagline == null
                            ? ""
                            : state.detail.tagline as String,
                        style: TextStyle(color: Colors.amber[900])),
                  ...
                  ListTile(
                    title: Text("Year",
                        style: TextStyle(
                            color: Colors.amber[900],
                            fontWeight: FontWeight.bold)),
                    subtitle: Text(state.detail.year as String,
                        style: TextStyle(color: Colors.amber[900])),
                    leading:
                  ...
                  ListTile(
                    title: Text("Raiting",
                        style: TextStyle(
                            color: Colors.amber[900],
                            fontWeight: FontWeight.bold)),
                    subtitle: Text(state.detail.imdbRating as String,
                        style: TextStyle(color: Colors.amber[900])),
